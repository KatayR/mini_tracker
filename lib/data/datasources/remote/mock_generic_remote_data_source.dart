...
class MockGenericRemoteDataSource<T extends BaseEntity> implements ICrudDataSource<T> {
  ...
  /// Updates an existing item, or creates it if not found (upsert behavior).
  ///
  /// This handles the case where an item exists locally but was never synced
  /// to remote (e.g., due to previous network failures).
  @override
